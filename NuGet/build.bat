...
nuget pack "%SOURCE_DIR%\VirtoCommerce.SitemapsModule.Core\VirtoCommerce.OrderModule.Core.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
